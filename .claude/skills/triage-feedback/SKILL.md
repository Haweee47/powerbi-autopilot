...
| Label | What to do |
|---|---|
| `render` | Reproduce: `python tools/quickstart.py --purpose <p> --theme <t> --lang <l>`, open in Desktop, capture every page it mentions. Reproduced → `accepted`. Not reproduced → ask for the Desktop version and a full-window capture |
