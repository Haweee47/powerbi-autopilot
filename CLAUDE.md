...
- [x] 배치 2종(왼쪽 레일 · 상단 메뉴, `--frame top`), 브랜드 색 테마 도구 (2026-09-17)
- [x] 업무 파일럿: 풀필먼트센터 운영 (`--purpose fulfillment`, 전용 모델·가상 데이터, 출고 → 손실 시간 → 시간대 → 팀 → 입고·재고). 사용자 업무의 우선순위는 출고 > 입고·재고 > 배송, 핵심 지표는 생산성(UPH/HTP)과 그 원인 (2026-09-17)
